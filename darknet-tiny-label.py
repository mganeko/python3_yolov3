...
def detect(net, meta, image, alp, thresh=.5, hier_thresh=.5, nms=.45):
    ...
    # -- save --
    save_image(im, "detect_result".encode('ascii'))
    free_image(im)
    free_detections(dets, num)
    return res

if __name__ == "__main__":
    # OK: net = load_net("cfg/yolov3.cfg".encode('ascii'), "yolov3.weights".encode('ascii'), 0)
    ...
    r = detect(net, meta, "data/dog.jpg".encode('ascii'), alphabet)
    #r = detect(net, meta, "data/sample1.png".encode('ascii'), alphabet)
    print(r)
